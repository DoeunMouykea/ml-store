            ...
            <footer className="footer-section spad">
                ...
                <div className="social-links-warp">
                    ...
                    <div className="container text-center pt-5">
                        <p>
                            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i className="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://mlstore.com" >ML Store group</a>
                        </p>
                    </div>
